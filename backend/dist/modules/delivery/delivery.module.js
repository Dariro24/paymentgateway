...
const delivery_orm_entity_1 = require("../../infrastructure/typeorm/entities/delivery.orm-entity");
...
exports.DeliveryModule = DeliveryModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([delivery_orm_entity_1.DeliveryOrmEntity])],
        controllers: [delivery_controller_1.DeliveryController],
        providers: [delivery_repository_1.DeliveryRepository],
    })
], DeliveryModule);
